          ...
          <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-6">
                ...
                <?php echo form_open('administration/type/edit',$attributes);?>
                <?php if (!empty($type)): ?>
                <?php echo form_hidden('id',$type->id); ?>
                <?php else: ?>
                <?php endif ?>
                <div class="form-group"><label class="col-sm-2 control-label text-right">name</label>
                <div class="col-sm-10"><input type="text" name="name_type" class="form-control" placeholder="Name type" value="<?php echo $type->name ?>">
